...
1. **Browse [Templates](https://developers.databricks.com/templates)** — Search and filter by service to find walkthrough prompts and full reference app codebases side by side.
