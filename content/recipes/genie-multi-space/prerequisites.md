...
- **A scaffolded AppKit app with the Genie feature.** Complete the [Genie Conversational Analytics](/templates/genie-conversational-analytics) recipe first. This recipe only covers the upgrade from one space to many — not the initial Genie wiring.
