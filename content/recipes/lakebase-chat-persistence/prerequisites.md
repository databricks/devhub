...
- **A scaffolded AppKit app with Lakebase wired up.** Complete the [Create a Lakebase Instance](/resources/lakebase-create-instance) and [Lakebase Data Persistence](/resources/lakebase-data-persistence) recipes first. This recipe adds chat tables on top of that setup.
