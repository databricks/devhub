...
- **A provisioned Lakebase project.** Complete the [Create a Lakebase Instance](/templates/lakebase-create-instance) recipe first and collect the project's endpoint host, endpoint resource path, database resource path, and PostgreSQL database name.
