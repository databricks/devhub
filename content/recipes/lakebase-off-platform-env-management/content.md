...
Use the `access_token` field for `DATABRICKS_TOKEN`. This token expires after about one hour; the [Token Management](/templates/lakebase-off-platform#lakebase-token-management) recipe covers automated refresh.
