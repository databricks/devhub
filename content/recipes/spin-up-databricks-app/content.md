...
- [Templates catalog](https://dev.databricks.com/templates) — fully composed templates (AI chat, app + Lakebase, Genie analytics, operational analytics) when the bare scaffold is not what you want.
