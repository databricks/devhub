  ...
  return (
    ...
    >
      ...
      <p className="mb-10 text-base leading-relaxed text-db-navy/75 dark:text-white/70">
        DevHub is the home for everything developers need to build on
        Databricks. Docs, templates, SDKs, agent skills, MCP servers, and guides
        for shipping data apps and AI agents on the Databricks platform &mdash;
        all in one place.
      </p>
