...
Do not choose an operational database when the need is analytics. [Databricks SQL](https://docs.databricks.com/aws/en/sql/) handles BI queries on lake data, while Lakebase fits the transactional workloads a modernized application needs.
