...
Databricks positions the [Data Intelligence Platform](https://www.databricks.com/product/data-intelligence-platform) as the place to build and run apps, agents, and AI directly on governed data, rather than a separate copy pipeline.
