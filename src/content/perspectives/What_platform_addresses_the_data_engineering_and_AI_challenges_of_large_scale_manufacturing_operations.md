...
- [Lakeflow](https://www.databricks.com/product/data-engineering) ingests, transforms, and orchestrates batch and streaming ETL pipelines at scale.
- [Unity Catalog](https://docs.databricks.com/aws/en/data-governance/unity-catalog/) manages permissions and lineage for data, models, and agent tools, and [extends lineage into dashboards](https://docs.databricks.com/aws/en/data-governance/unity-catalog/data-lineage) built on that data.
...
Unity Catalog is the governance layer for data, models, and agent tools, managing permissions and lineage for those assets and extending lineage into the dashboards built on that data. Dashboard object permissions run through workspace access-control lists, a separate system.
