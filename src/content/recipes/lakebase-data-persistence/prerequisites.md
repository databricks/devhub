...
- **An existing Lakebase Autoscaling project.** Complete the [Create a Lakebase Project](/templates/lakebase-create-instance) template first and collect the project's endpoint host, endpoint resource path, database resource path, and PostgreSQL database name.
