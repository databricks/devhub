...
- **An existing Lakebase Autoscaling project.** Complete the [Create a Lakebase Project](/templates/lakebase-create-instance) template first so you have an endpoint host, database, and endpoint resource path available as `PGHOST`, `PGDATABASE`, and `LAKEBASE_ENDPOINT`.
