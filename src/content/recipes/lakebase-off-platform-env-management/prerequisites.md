...
- **An existing Lakebase Autoscaling project.** Complete the [Create a Lakebase Project](/templates/lakebase-create-instance) template first. You will read connection values from its branch, endpoint, and database.
