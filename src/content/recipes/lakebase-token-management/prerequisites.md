...
- **An existing Lakebase Autoscaling project.** Complete the [Create a Lakebase Project](/templates/lakebase-create-instance) template first so you have a `LAKEBASE_ENDPOINT` resource path to pass to the credentials API.
